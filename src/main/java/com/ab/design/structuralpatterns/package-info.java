package com.ab.design.structuralpatterns;
 ...
 * Bridge	    is used to decouple the interfaces from implementation and hiding the implementation details from the client program.
